...
class QuizActivity : AppCompatActivity() {
    ...
    private lateinit var tumSecenekler: HashSet<Bayraklar> //HashSet olduğu için sırayı karıştırıcak zaten
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        sorular = Bayraklardao().rasgele5BayrakGetir(vt) //rasgele 5 bayrağı sorular arraylistine atmış olduk
